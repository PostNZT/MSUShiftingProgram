<div class="row detailed">
 <div class="col-lg-12 detailed">
    <form role="form" class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{\route('staff.student.request.details.update-personal-information', $student)}}">
      {{ csrf_field() }}
      {{ method_field('PATCH') }}
      @if ($errors->any())
