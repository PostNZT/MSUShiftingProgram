    ...
    <div id="student-info" class="tab-pane">
      <div class="row detailed">
        <div class="col-lg-8 col-lg-offset-2 detailed">
            ...
            @include('admin::student.listing.layouts.personal-info')
        </div>
      </div>
    </div>
    <div id="student-status" class="tab-pane">
      <div class="row detailed">
        <div class="col-lg-8 col-lg-offset-2 detailed">
            ...
            @include('admin::student.listing.layouts.update-status')
        </div>
      </div>
    </div>
  </div>
      ...
      $(function() {
          var table = $('#student-table').DataTable({
              ...
              "ajax":{
                  ...
                  url: "{{\route('admin.student.details.api.listing.datatable', $student)}}"
              }
          });
      });
  });
