(function ( $ ) {
    $.fn.user_profile_pic_update = function (options) {
        function randomizer(){
        ...
        return this.each(function() {
            ...
            let element = '<div id="cm-profile-pic_'+guid+'_container" >' +
                ...
                '<a type="button" class="btn-primary" id="cm-profile-pic_'+guid+'_btn" style="background:#4285F4;left:'+adjustedWidth()+'px;bottom:-2px;padding: 0px 10px 0px 10px;position: absolute;border-radius: 10px;">Edit</a>' +
                '</div>';
            div.append(element);
